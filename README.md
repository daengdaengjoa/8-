...
- **API 명세서**: [네이버 영화 API]([https://developers.naver.com/docs/search/movie/](https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=%EC%98%81%ED%99%94))
###  API-2
